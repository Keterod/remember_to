...
| RF-24 | Buscar actividades | El sistema debe permitir buscar actividades principalmente desde módulos de edición o consulta. | Actividades generales | Media | Intermedia |
...
| RF-56 | Notificar nuevamente si no se marca | El sistema debe repetir una notificación cuando una actividad no haya sido marcada como completada, considerando límites de Android para alarmas y segundo plano. | Notificaciones | Alta | Intermedia |
| RF-57 | Completar desde notificación | El sistema debe permitir completar una actividad directamente desde la notificación cuando el sistema operativo lo permita. | Notificaciones | Alta | Intermedia |
| RF-58 | Posponer desde notificación | El sistema debe permitir posponer una actividad directamente desde la notificación cuando el sistema operativo lo permita. | Notificaciones | Alta | Intermedia |
